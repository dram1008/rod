...
<div class="site-contact">
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <p>
                Алентство имеет уникальную разработанную методику “Осозанного воплощения”, которая позволяет пройти
                промежуточное состояние с сохранением памяти или осознанным выбором Нового Тела Аватара. Эти технологии применяются в
                Школе Богов где из людей делают Богов. В 21 марта 2016 г. она получила лицензию от Агентства Сертификации "Золотой Век Творца".
                Все желающие могут теперь воспользоваться этой новой технологией.
                Для этого нужно пройти месячный цикл реабилитации от осложнений Матричной Структуры.
                Заказать ее можно написав нам или позвонив.
            </p>
